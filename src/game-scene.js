...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.image((this.game.config.width - 50), this.game.config.height - 240, 'flagImg')
            .setScale(0.5, 0.35)
            .setFlipX(true)
            .setDepth(11);
    ...
    */
    ...
    updateRunner() {
        ...
        if (this.startMovingRunner && this.showWonGame === false) {
            this.moveRunner(this.runner, 0.75);
            this.bgStartMoving = true;
        }
    ...
    checkForWonGame() {
        if (this.runner.x > this.game.config.width - 50) {
